...
export const ProviderDialog = ({open, onClose}) => {
    ...
    // Description text for the currently selected provider
    const providerDescKey = `dialog.provider.${provider}_desc`;
    const providerDesc = t(providerDescKey, {defaultValue: ""});
